    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTagContainerLayout1.setOnTagClickListener(new TagView.OnTagClickListener() {
            ...
            public void onTagClick(int position, String text) {
                Toast.makeText(tempActivity.this, "click-position:" + position + ", text:" + text,
                        Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onTagLongClick(final int position, String text) {
                AlertDialog dialog = new AlertDialog.Builder(tempActivity.this)
                        .setTitle("long click")
...
//                mTagContainerLayout1.removeTag(position);
                Toast.makeText(tempActivity.this, "Click TagView cross! position = " + position,
                        Toast.LENGTH_SHORT).show();
            }
        });
