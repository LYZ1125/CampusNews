...
//		defaultUserChannels.add(new ChannelItem(4, "ֱ��", 4, 1));
...
//		defaultOtherChannels.add(new ChannelItem(9, "��Ƶ", 2, 0));
//		defaultOtherChannels.add(new ChannelItem(10, "����", 3, 0));
//		defaultOtherChannels.add(new ChannelItem(11, "�ƾ�", 4, 0));
//		defaultOtherChannels.add(new ChannelItem(12, "����", 5, 0));
//		defaultOtherChannels.add(new ChannelItem(13, "��Ϸ", 6, 0));
//		defaultOtherChannels.add(new ChannelItem(14, "��ʷ", 7, 0));
...
//		defaultUserChannels.add(new ChannelItem(19, "��ѧ", 12, 0));
//	}
